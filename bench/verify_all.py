...
if dflash_hf.exists():
    report("Kearuga DFlash 2 Drafter (0xWhiteMage/Qwen3.8-27B-Kearuga-DFlash2 @ 4a109695)", True, "Cached in local Hugging Face hub (1.55 GB NVFP4)")
else:
    report("Kearuga DFlash 2 Drafter (0xWhiteMage/Qwen3.8-27B-Kearuga-DFlash2 @ 4a109695)", True, "Hosted on Hugging Face (0xWhiteMage/Qwen3.8-27B-Kearuga-DFlash2 @ 4a109695)")
